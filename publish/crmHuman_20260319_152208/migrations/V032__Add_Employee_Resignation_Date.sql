-- =============================================
-- Migration: V032__Add_Employee_Resignation_Date
-- Author: System
-- Date: 2026-01-11
-- Description: Add ResignationDate column to Employees and update sp_emp_insert/sp_emp_update.
-- =============================================

IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[Employees]') AND name = 'ResignationDate')
BEGIN
