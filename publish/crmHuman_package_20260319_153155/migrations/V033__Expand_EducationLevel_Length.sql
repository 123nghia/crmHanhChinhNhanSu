-- =============================================
-- Migration: V033__Expand_EducationLevel_Length
-- Author: System
-- Date: 2026-01-11
-- Description: Expand EducationLevel length to match MasterData.Code and update sp_emp_insert/sp_emp_update.
-- =============================================

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[Employees]') AND name = 'EducationLevel')
BEGIN
    ALTER TABLE [dbo].[Employees] ALTER COLUMN [EducationLevel] VARCHAR(8) NULL;
END
GO
