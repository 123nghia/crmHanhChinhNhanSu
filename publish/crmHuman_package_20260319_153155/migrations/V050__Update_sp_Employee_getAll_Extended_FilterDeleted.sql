-- =============================================
-- Migration: V050__Update_sp_Employee_getAll_Extended_FilterDeleted
-- Author: System
-- Date: 2026-01-16
-- Description: Cập nhật sp_Employee_getAll_Extended để luôn lọc bỏ các bản ghi đã xóa (Deleted=1)
--              bất kể tham số @IsDeleted là gì.
-- =============================================
...
-- Kiểm tra và tạo lại stored procedure
...
PRINT '  → Creating procedure sp_Employee_getAll_Extended (Updated logic)...';
GO
...
(
    ...
    @IsDeleted bit = 0 -- Tham số này sẽ bị bỏ qua logic, luôn filter deleted
)
AS
BEGIN
    SET NOCOUNT ON;
...
PRINT '  ✓ Procedure sp_Employee_getAll_Extended updated successfully (Force filter Deleted=0)';
GO
