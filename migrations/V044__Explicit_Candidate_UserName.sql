-- =============================================
-- Migration: V044__Explicit_Candidate_UserName
-- Author: System
-- Date: 2026-01-16
-- Description: Explicitly select UserName in sp_candidate_getAll
-- =============================================

BEGIN TRANSACTION;

PRINT 'Applying migration V044: Explicit Candidate UserName...';
...
PRINT '  + Recreating procedure sp_candidate_getAll with explicit UserName...';
...
-- Explicitly selecting d.UserName and d.* covering others
...
d.UserName, -- Explicitly added here to ensure mapping
d.* 
from  Candidate d  '';
...
PRINT 'Migration V044 completed.';
COMMIT TRANSACTION;
